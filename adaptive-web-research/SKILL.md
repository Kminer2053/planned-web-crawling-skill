...
description: Flexible web and document collection for research-oriented crawling. Use when Codex needs to inspect an unfamiliar source, plan a collection strategy, and gather data across HTML pages, JSON endpoints, PDFs, forms, cookies, or simple pagination while preserving reproducible evidence and intermediate snapshots.
---
